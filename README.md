...
- [markmoxon/elite-source-code-bbc-micro-cassette](https://github.com/markmoxon/elite-source-code-bbc-micro-cassette) - Fully documented source code for the cassette version of the classic game Elite on the BBC Micro
...
- [s60sc/ESP32_AdBlocker](https://github.com/s60sc/ESP32_AdBlocker) - ESP32 based DNS sinkhole for ads and trackers
...
- [FusionAuth/fusionauth-jwt](https://github.com/FusionAuth/fusionauth-jwt) - A simple to use Java JWT Library. Verify, Sign, Encode, Decode all day.
...
- [shaftoe/pi-coding-agent-action](https://github.com/shaftoe/pi-coding-agent-action) - GitHub action to integrate https://pi.dev/ coding agent with GitHub-compatible CI/CD, issues and PRs
